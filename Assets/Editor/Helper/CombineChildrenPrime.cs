...
public class CombineChildrenPrime: MonoBehaviour {
    ...
    public bool generateTriangleStrips = true, combineOnStart = true, destroyAfterOptimized = false, castShadow = true, receiveShadow = true, keepLayer = true, addMeshColliderAfter=false;
    ...
    public void Combine ( bool _destroyImmediate = false ) 
    {
        if ( combined )
            return;
        combined = true;
